...
export default () => {
    ...
    const arrangeData = (data) => {
        ...
        return data.map(datum => {
            return { key: datum.id, value: getPercentage(datum.vol24HrUsd, totalMarketCap), symbol: datum.symbol, priceUsd: datum.priceUsd, percentageChange24HrUsd: datum.percentageChange24HrUsd }
        })
    }
