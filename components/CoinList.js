    ...
    return(
        <Fragment>
            ...
            {displayInfo.map(  (display, index) =>
                 (<CoinCard key={index} symbol={displayInfo.symbol} priceUsd={displayInfo.priceUsd} percentageChange24HrUsd={displayInfo.percentageChange24HrUsd} style={changeColor}/>)
                )}
        </Fragment>
    )
}
